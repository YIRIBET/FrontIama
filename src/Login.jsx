...
function Login() {
  return (
    <>
    <h1>ijhgfdrsewzx g</h1>

<div class=" max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 w-full max-w-sm  bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">

<form class="max-w-md mx-auto">
<img class="p-8 rounded-t-lg " src="src\assets\LOGOiAMA.png" alt="" />
  ...
  <button type="submit" class="text-white flex flex-wrap items-center justify-between mx-auto text-gray-900 bg-gradient-to-r from-lime-200 via-lime-00 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300  font-lg rounded-lg text-sm px-9 py-4 text-center ">Registrar</button>
</form>
