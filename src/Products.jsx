...
function Products() {
  const [modalVProduc, setModalVProduc] = useState(false); // Estado para el modal de producto
  ...
  const MostrarModalProd = () => setModalVProduc(true);
  const CerrarModalProd = () => setModalVProduc(false);
  const MostrarModalDelete = (product) => {
    setProductToDelete(product);
    setModalVDelete(true);
  };
  const CerrarModalDelete = () => setModalVDelete(false);

  const handleDelete = () => {
    console.log(`Product ${productToDelete} deleted`);
    CerrarModalDelete();
  };
    ...
    <>
          ...
          <tbody>
            <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              ...
              <td className="px-6 py-4">
                ...
                <button
                  onClick={() => MostrarModalDelete("Apple MacBook Pro 17")}
                  type="submit"
      ...
      {modalVProduc && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
          ...
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 max-20">
            ...
            <form className="max-w-sm  mt-4  mb-2 relative z-0 w-full mb-5 group grid md:gap-6">
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="mb-4">
              ...
              <span className="font-bold">{productToDelete}</span>?
            </p>
